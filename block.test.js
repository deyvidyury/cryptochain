...
describe('Block',() => {
  ...
  it('has a timestamp, a lastHash, hash, and data properties',() => {
  ...
  describe('mineBLock()',() => {
    ...
    it('sets the `lastHash` to be the `hase` of the lastBlock',() => {
